...
- `gpu-operator-mig-enforcer.yaml` - CronJob that ensures the GPU operator's MIG strategy stays set to "mixed". Magnum resets this setting on every nodegroup create/delete operation. See [MIG strategy enforcement docs](../../docs/admin/cluster-creation-and-resizing.md#enable-mixed-mig-strategy) for details.
